...
SECRET_KEY = 'django-insecure-h^+$@9(i^21zj#o+j1=aftk(4ob==l_jeyghh!(wh1(n@q*)w0'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['djangoportafoliorailways-production.up.railway.app']
